...
const UserSessionPage: NextPage = () => {
    ...
    useEffect(() => {
        const fetchUserData = async () => {
            ...
            if (id) {
                try {
                    const response = await axios.get(`http://localhost:3000/api/v1/users/session/${id}`, {
                        headers: {
    ...
    return (
        <div className="flex flex-col justify-center items-center min-h-screen text-gray-700">
            <div className="mb-4">
                <h1 className="text-green-700">User Session Page</h1>
            </div>
